 ...
 */
public class MinPriority<T extends Comparable<T>> {

    public static void main(String[] args) {
        // just do it...
        MinPriority<Double> priorityQueue = new MinPriority<>(100);
        for (int i = 0; i++ < 100;) {
    ...
    private boolean lager(int i, int j) {
